...
@section('content')
    ...
    <div class="ui segments">
        ...
        <div class="ui segment">
            ...
            @endif
            <form method="post" class="ui form error" role="form" action="{!! action('Admin\EventsController@update') !!}">
                {!! csrf_field() !!}
                {{ Form::hidden('auth', $event->id) }}
                <div class="required field">
                    <label class="ui"> Unidad </label>
                    <input type="text" name="event" value="{{{ $event->title }}}">
